...
export default function UploadPage() {
  return (
    <>
      <SEOHead title="Dokumente hochladen" description="Fotografieren Sie Ihre Dokumente" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Dokumente hochladen</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              Fotografieren Sie Ihre Dokumente
            </p>
            <div style={{
