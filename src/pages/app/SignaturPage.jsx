...
export default function SignaturPage() {
  return (
    <>
      <SEOHead title="Digitale Unterschrift" description="Vollmacht elektronisch unterzeichnen" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Digitale Unterschrift</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              Vollmacht elektronisch unterzeichnen
            </p>
            <div style={{
