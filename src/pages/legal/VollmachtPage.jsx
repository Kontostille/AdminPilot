...
export default function VollmachtPage() {
  return (
    <>
      <SEOHead title="Vollmacht" description="Informationen zur digitalen Vollmacht" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Vollmacht</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              Informationen zur digitalen Vollmacht
            </p>
            <div style={{
