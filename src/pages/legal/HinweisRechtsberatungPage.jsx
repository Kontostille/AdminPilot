...
export default function HinweisRechtsberatungPage() {
  return (
    <>
      <SEOHead title="Keine Rechtsberatung" description="AdminPilot ist eine technische Ausfüllhilfe" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Keine Rechtsberatung</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              AdminPilot ist eine technische Ausfüllhilfe
            </p>
            <div style={{
