...
export default function SoFunktioniertsPage() {
  return (
    <>
      <SEOHead title="So funktioniert's" description="In 3 einfachen Schritten zu Ihrer Leistung" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>So funktioniert's</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              In 3 einfachen Schritten zu Ihrer Leistung
            </p>
            <div style={{
