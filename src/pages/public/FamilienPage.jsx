...
export default function FamilienPage() {
  return (
    <>
      <SEOHead title="Für Familien & Berufstätige" description="Kein Geld verschenken – prüfen Sie Ihren Anspruch" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Für Familien & Berufstätige</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              Kein Geld verschenken – prüfen Sie Ihren Anspruch
            </p>
            <div style={{
