...
export default function LeistungscheckPage() {
  return (
    <>
      <SEOHead title="Kostenloser Leistungscheck" description="Finden Sie heraus, worauf Sie möglicherweise Anspruch haben" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Kostenloser Leistungscheck</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              Finden Sie heraus, worauf Sie möglicherweise Anspruch haben
            </p>
            <div style={{
