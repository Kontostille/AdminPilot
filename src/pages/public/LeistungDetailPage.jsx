...
export default function LeistungDetailPage() {
  return (
    <>
      <SEOHead title="Leistung" description="Detailinformationen zur ausgewählten Leistung" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Leistung</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              Detailinformationen zur ausgewählten Leistung
            </p>
            <div style={{
