    ...
    <>
      ...
      <section className="section" style={{ background: '#FFF' }}>
        <div className="container" style={{ maxWidth: 'var(--max-width-content)' }}>
          ...
          {[`Fotografieren Sie die oben genannten Dokumente`, `Unsere KI prüft Ihren möglichen Anspruch auf ${leistung.name}`, `Sie unterschreiben digital – der Antrag wird automatisch eingereicht`].map((s, i) => (
