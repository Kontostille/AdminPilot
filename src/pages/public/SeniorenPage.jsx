    ...
    <>
      ...
      <section className="section" style={{ background: 'var(--color-bg)' }}>
        <div className="container" style={{ maxWidth: 'var(--max-width-narrow)' }}>
          ...
          {['Fotografieren Sie Ihren Rentenbescheid mit dem Smartphone', 'Wir prüfen, welche Leistungen für Sie in Frage kommen könnten', 'Der fertig ausgefüllte Antrag wird für Sie erstellt – mit Anleitung zum Einreichen'].map((s, i) => (
        ...
        <div className="container" style={{ maxWidth: 'var(--max-width-narrow)' }}>
          <div style={{ background: 'var(--color-bg)', borderRadius: 'var(--radius-xl)', padding: 'var(--space-8)', borderLeft: '4px solid var(--ap-gold)' }}>
            <p style={{ fontSize: 'var(--text-lg)', fontStyle: 'italic', lineHeight: 1.7, marginBottom: 'var(--space-4)' }}>
              „Mein Enkel hat mir AdminPilot gezeigt. Ich hätte nie gedacht, dass ein KV-Zuschuss überhaupt für mich in Frage kommt. Nach Bewilligung spare ich über 200 € im Monat."
            </p>
