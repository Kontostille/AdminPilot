...
export default function SeniorenPage() {
  return (
    <>
      <SEOHead title="Für Rentner & Senioren" description="Bekommen Sie alles, was Ihnen zusteht?" />
      <div className="section">
        <div className="container">
          <div style={{
            ...
            <h1 style={{ marginBottom: 'var(--space-4)' }}>Für Rentner & Senioren</h1>
            <p style={{ color: 'var(--color-text-muted)', maxWidth: '500px', margin: '0 auto' }}>
              Bekommen Sie alles, was Ihnen zusteht?
            </p>
            <div style={{
